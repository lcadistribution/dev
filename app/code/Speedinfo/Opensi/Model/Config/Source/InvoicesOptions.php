...
class InvoicesOptions implements \Magento\Framework\Option\ArrayInterface
{
	/**
   * Options getter
   *
  ...
  {
  	return [['value' => 0, 'label' => __('Use Magento invoices')], ['value' => 1, 'label' => __('Use OpenSi invoices')]];
  }
}
