<?php
namespace LCA\ProductRulesPrice\Ui\DataProvider\Product\Form\Modifier;
...
class ProductRulesPriceTab extends AbstractModifier
{
    ...
    const PRODUCT_RULES_PRICE_TAB_INDEX = 'product_rules_price_2';
    ...
    protected function getPricesBlock()
    {
        return $this->layout->createBlock(
            \LCA\ProductRulesPrice\Block\Adminhtml\Prices::class,
            'lca.product.productrulesprice'
        );
    }
}
