...
class Data extends AbstractData
{
     ...
     */
    public function getCategoryState($store = null)
    {
        $categoryIds = $this->getModuleConfig('filter/state/categories', $store);
        if (!is_array($categoryIds)) {
            $categoryIds = explode(',', $categoryIds ?? '');
        }
     ...
     * @return array|false|mixed|string[]
     */
    public function getCategoryRating($store = null)
    {
        $categoryIds = $this->getModuleConfig('filter/rating/categories', $store);
        if (!is_array($categoryIds)) {
            $categoryIds = explode(',', $categoryIds ?? '');
        }
