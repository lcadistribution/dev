...
class View extends Action
{
    ...
    protected function _initParam($page)
    {
        ...
        if (!$this->_coreRegistry->registry('current_product_page')) {
            $this->_catalogSession->setData('current_product_page', $page);
            $this->_catalogSession->setData('current_product_page_params', $params);
        }
