...
class Data extends AbstractData
{
     ...
     * @return array|mixed
     */
    public function isEnabledHighLightLinks()
    {
        return $this->getConfigGeneral('high_light_links/enabled');
    }
    ...
    {
        return $this->getConfigGeneral('high_light_links/text_color');
    }
    ...
    public function getHtmlHighLight($layout = null)
    {
        ...
        if (!$this->isEnabledHighLightLinks() || !$color) {
            return false;
        }
        if ($layout === null) {
            return true;
        ...
        return $layout->createBlock(Template::class)
            ->setTemplate('Mageplaza_LayeredNavigationUltimate::layered/high_light_link.phtml')
            ->toHtml();
    }
     ...
     */
    public function getShowStockEnd()
    {
        return $this->getConfigGeneral('show_out_of_stock_end');
    }
}
