...
define([
    ...
    $.widget('bss.preorder_product', {
        ...
        _changeButton: function () {
            var self = this;
            self.options.pre_order_availability_message = $("<div/>").html(self.options.pre_order_availability_message).text();
        ...
        _ApplyForProductPage: function (elemnt) {
            ...
            if (self.options.pre_order_availability_message) {
                let availabilityMessage = $t(self.options.pre_order_availability_message);
