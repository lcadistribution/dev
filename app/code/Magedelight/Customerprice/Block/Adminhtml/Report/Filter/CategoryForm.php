...
class CategoryForm extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    {
        $actionUrl = $this->getUrl('*/*/customercategoryprice');
        ...
        $htmlIdPrefix = 'customercategoryprice_report_';
