...
namespace Magedelight\Customerprice\Block\Adminhtml\Catalog\Price\Customerprice\Grid;
...
class CustomerpriceGrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->_collectionFactory->create()->addFieldToFilter('product_id',$productId)->setOrder('customer_id');
    ...
    {   
        ...
        'delete_action', [
            ...
            'actions' => [
                [
                    'caption' => __('Delete'),
                    'url' => ['base' => '*/customer/customerpricedelete'],
                    'field' => 'id',
                ],
            ],
            'filter' => false,
